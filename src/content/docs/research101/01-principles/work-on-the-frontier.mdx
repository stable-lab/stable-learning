...
**Knobs.** One slider — where your months go. At 1.0 you grind tricks on familiar ground: maximum paper output, zero motion toward the edge. At 0.0 you spend the months reading and working at the boundary: fewer papers, but you close the gap and eventually track the edge as it moves.
